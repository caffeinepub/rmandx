...
export class Backend implements backendInterface {
    ...
    async addOrUpdateDayEntry(arg0: DayEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateDayEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteDayEntry(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getAllDayEntries(): Promise<Array<DayEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDayEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDayEntry(arg0: string): Promise<DayEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getDayEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
